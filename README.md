...
* **4-band EQ** per deck (High / Mid / Low / Gain) on knobs whose arc is the readout — it grows
  from twelve o'clock, green for a boost and red for a cut — each with a hold-to-kill switch and a
  reset dot
